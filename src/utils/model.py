# Script based on work by Marvin A. Ruder
# Original script can be found at: https://github.com/marvinruder/ssd/blob/master/SRC/model.py
...
class MultiBoxLoss(nn.Module):
    ...
    def _init_(self, priors_cxcy, threshold=0.5, neg_pos_ratio=3, alpha=1.):
        super(MultiBoxLoss, self)._init_()
